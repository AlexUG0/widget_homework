...
**Описание:** содержит декоратор log, который логирует результаты выполнения функции или возникшие ошибки.
...
### Модуль read_transaction_files
### Функции
#### 1. `read_transactions_from_csv`

**Описание:** считывает финансовые операции из CSV файла.

**Возвращает:** список словарей с транзакциями.

#### 2. `read_transactions_from_excel`

**Описание:** считывает финансовые операции из Excel файла.
